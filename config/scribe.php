...
return [
   ...
   'title' => 'Lelang App API Documentation',

'description' => 'Dokumentasi REST API untuk platform lelang daring realtime.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'api/broadcasting/*', // skip endpoint internal broadcasting auth
                // 'GET /health', 'admin.*'
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'use_value' => env('SCRIBE_AUTH_KEY', '1|REPLACE_WITH_VALID_TOKEN'),
        ...
        'extra_info' => 'Dapatkan token dengan login via /api/login, lalu gunakan sebagai Bearer Token.',
],
